...
create table tb_guest
	(GUEST_PNO varchar(20) primary key, M_COUNT int not null, GUEST_NAME varchar(20) not null, STAY_DAYS int not null, PARKING_YN varchar(1) not null, ROOM_NO int, constraint foreign key(ROOM_NO) references tb_room(ROOM_NO));
